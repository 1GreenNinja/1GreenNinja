...
class TypingSpeedTest:
    def __init__(self, root):
        ...
        self.sample_texts = [
            ...
            "Technology is best when it brings people together. The future belongs to those who prepare for it today. Innovation distinguishes between a leader and a follower.",
            "Practice makes perfect, but nobody is perfect, so why practice? This humorous paradox reminds us that the journey of improvement is more important than achieving perfection.",
    ...
    def calculate_results(self):
        ...
        # WPM calculation (net WPM = gross WPM - errors)
